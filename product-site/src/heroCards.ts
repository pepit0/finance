...
const cardIcons: Record<HeroDifferentiatorIcon, string> = {
  ...
  ai: `<svg class="heroCardIconSvg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v3M12 18v3M3 12h3M18 12h3" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round"/><circle cx="12" cy="12" r="4" fill="none" stroke="currentColor" stroke-width="1.75"/><path d="m8 8 2 2M14 14l2 2M16 8l-2 2M10 14l-2 2" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round"/></svg>`
};
