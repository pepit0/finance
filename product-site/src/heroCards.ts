...
const cardIcons: Record<HeroDifferentiatorIcon, string> = {
  support: `<svg class="heroCardIconSvg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3a7 7 0 0 0-4 12.7V19a1 1 0 0 0 1 1h2v-2.3A7 7 0 1 0 12 3Z" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round"/><path d="M9 21h6" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round"/></svg>`,
