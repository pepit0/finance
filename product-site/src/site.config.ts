...
const defaults: SiteConfig = {
  productName: "Tempt Technologies",
  heroTagline: {
  ...
  addOnsIntro:
    "Your business doesn't run like everyone else's. We build custom add-ons that plug straight into Tempt Technologies · tailored to your workflow, your tools, and your team.",
  addOnProcessSteps: [
    {
