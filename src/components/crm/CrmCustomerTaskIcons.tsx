...
export function ChatNavIcon({ className = "crmCustomerTaskIconSvg" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
      ...
      focusable="false"
    >
      <path d="M21 11.5a8.4 8.4 0 0 1-1.1 4.2 8.5 8.5 0 0 1-7.4 4.3 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.3-7.4 8.4 8.4 0 0 1 4.2-1.1H12a8.5 8.5 0 0 1 8 8.5z" />
    </svg>
  );
}
