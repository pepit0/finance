-- Run once in the **marketing** Supabase project (SQL Editor as postgres).
-- Public pre-approvals from the website. Does NOT reference CRM helpers like user_has_crm_access().
-- Inserts go through RPC only; anon cannot read rows; no app user needs SELECT on this table.
